...
extension URL {
    ...
    static let featureFlags = URL(string: "https://letswift.kr/2025/assets/json/app_feature_flags.json")!
    static let commemorativePass2025 = URL(string: "https://letswift.kr/2025/assets/pass/commemorative_pass_2025.pkpass")!
}
